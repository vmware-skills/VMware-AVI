...
carried — and this skill's five ``confirmed`` flags were among them — the parameters that
decide whether a Virtual Service stops serving traffic or an AKO pod is
deleted, described to the agent as ``boolean`` and nothing else.
